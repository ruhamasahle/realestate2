...
import {FaBed, FaBath, FaImages} from 'react-icons/fa'
...
const PropertyDetails = ({propertyDetails: {rooms, bath, price, purpose, photos, amenities, furnishingStatus, description,area,title, isVerified, type, agency, rentFrequency }} )=> (
